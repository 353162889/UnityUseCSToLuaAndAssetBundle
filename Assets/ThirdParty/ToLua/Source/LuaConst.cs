...
{
    public static string luaDir = Application.dataPath + "/ResourceEx/Lua/Custom";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/ResourceEx/Lua/ToLua";        //tolua lua文件目录
    public static string toluaCSDir = Application.dataPath + "/ThirdParty/ToLua";//添加 tolua cs文件目录,ToLua.cs文件使用
